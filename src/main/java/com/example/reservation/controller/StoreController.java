...
public class StoreController {
    ...
    @Operation(summary = "예약자 확인", description = "지점별, 수업별 예약자를 확인합니다.", parameters = {
            @Parameter(name = "storeId", required = true, example = "1", description = "지점 ID"),
            @Parameter(name = "lessonId", required = false, example = "1", description = "수업 ID"),
            @Parameter(name = "reservationDate", required = false, example = "2023-11-20", description = "예약 일자")
    })
    @ApiResponses(value = {
